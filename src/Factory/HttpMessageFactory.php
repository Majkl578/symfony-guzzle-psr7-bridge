...
final class HttpMessageFactory implements HttpMessageFactoryInterface
{
    ...
    private function detectRequestProtocol(Request $symfonyRequest) : string
    {
     ...
     */
    private function createUploadedFiles(Request $symfonyRequest) : array
    {
        $files = [];
     ...
     * @return string[][]
     */
    private function createResponseHeaders(Response $symfonyResponse) : array
    {
    ...
    private function createResponseStream(Response $symfonyResponse) : StreamInterface
    {
    ...
    private function createStreamFromBinaryFileResponse(BinaryFileResponse $symfonyResponse) : StreamInterface
    {
    ...
    private function createStreamFromStreamedResponse(StreamedResponse $symfonyResponse) : StreamInterface
    {
        ...
        ob_start(function (string $output) use ($stream) : string {
            $stream->write($output);
            return '';
        });
    ...
    private function createStreamFromResponseContent(Response $symfonyResponse) : StreamInterface
    {
